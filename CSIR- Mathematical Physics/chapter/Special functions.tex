...
\intertext{Plugging the values of r in   $ x^{r-1}$We can show  $a_{1}=0$ , and what left with the equation is} \\
...
\text{since }a_1 =0, \ &
a_{3},\  a_{5}, \ a_{7},....=0
\intertext{For even indice coefficients, $n=2k$}
...
\end{align*}
For perticular value of $a_0$ this solution is given a special name, $ J_P(x)$, Bessel function of $I$ kind and $P$ is order of Bessel function.
...
(iii) $\mathrm{J}_{0}(\mathrm{x})$ has nodes at $x=2.408,5.5201$......and $J_{1}(x)$ has nodes at $x=3.8317,7.015$.......
\begin{align*}
