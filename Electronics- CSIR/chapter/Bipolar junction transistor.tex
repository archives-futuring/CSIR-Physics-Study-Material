...
\begin{figure}[H]
	\centering
	\includegraphics[height=4.5cm,width=8.5cm]{diagram-20210816(32)-crop}
\end{figure}
\begin{tasks}(4)
	\task[\textbf{A.}] 20
	\task[\textbf{B.}] 24
...
\begin{figure}[H]
	\centering
	\includegraphics[height=5cm,width=5.5cm]{diagram-20210817-crop}
\end{figure}
\end{enumerate}
 \colorlet{ocre1}{ocre!70!}
\colorlet{ocrel}{ocre!30!}
...
\end{answer}	
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=4.5cm,width=3cm]{diagram-20211109(19)-crop}
		\end{figure}
	\end{minipage}
	\begin{answer}
		$$\beta=\frac{I_C}{I_B}$$
	...
	\end{answer}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=3.5cm,width=9cm]{diagram-20211108(13)-crop}
		\end{figure}
		If the transistors in Figures (a) and (b) have current gain $\left(\beta_{d c}\right)$ of 100 and 10 respectively, then they operate in the\\
	\end{minipage}
	\begin{answer}
	...
	For figure (a)
	\begin{align*}
	I_{B}&=\frac{10.7-0.7}{10}=1 \mathrm{~mA} \\ I_{C}&=B I_{B}=100 \mathrm{~mA}\\
	...
	For Figure (b)
	\begin{align*}
	I_{B}&=\frac{5-0.7}{10}=0.43 \mathrm{~mA} \\ I_{C}&=B I_{B}=4.3 \mathrm{~mA}\\
...
\end{answer}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=5cm,width=3.5cm]{diagram-20211109(9)-crop}
	\end{figure}
\end{minipage}
\begin{answer}
