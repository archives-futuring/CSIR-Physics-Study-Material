...
\begin{figure}[H]
	\centering
	\includegraphics[height=3.3cm,width=5cm]{OP-1}
\end{figure}
...
\begin{answer}$\left. \right. $
	\begin{figure}[H]
		\centering
		\includegraphics[height=3.3cm,width=5cm]{OP-2}
	\end{figure}
...
\end{answer}
\item \text { Consider the voltage regulator circuit shown in the figure below : }
\begin{figure}[H]
	\centering
	\includegraphics[height=4cm,width=5.1cm]{OP-3}
\end{figure}
...
\begin{answer}$\left. \right. $
	\begin{figure}[H]
		\centering
		\includegraphics[height=4cm,width=5.5cm]{OP-4}
	\end{figure}
	\begin{align*}
	V_{A} &=6 \mathrm{~V} \\
