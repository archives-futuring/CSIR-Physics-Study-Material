...
\begin{enumerate}
	...
	\begin{answer}$\left. \right. $
		The circuit can be redrawn in the form of voltage source as [Current $\rightarrow$ voltage source]
			\begin{figure}[H]
			\centering
			\includegraphics[height=3cm,width=5.2cm]{Ep-5}
		\end{figure}
		\begin{align*}
		\text { Applying KVL }\\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=4.3cm]{Ep-7}
	\end{figure}
	\begin{answer}
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.3cm,width=9cm]{Ep-8}
	\end{figure}
	\end{answer}
	...
	\begin{answer}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.7cm,width=7cm]{Ep-20}
		\end{figure}
		\begin{align*}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=3.7cm]{Ep-21}
		\end{figure}
		\begin{align*}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=5.6cm]{Ep-24}
	\end{figure}
	\begin{answer}
		The equivalent circuit after shorting $a b$ terminal.
		\begin{figure}[H]
			\centering
			\includegraphics[height=3cm,width=7.6cm]{Ep-25}
		\end{figure}
		\begin{align*}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=5.9cm]{Ep-26}
	\end{figure}
	\begin{answer}
	...
	\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.8cm,width=6cm]{Ep-29}
		\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=5.7cm]{Ep-30}
	\end{figure}
	\begin{answer}
		\begin{align*}
		...
		\textbf{$\mathbf{V}_{\mathbf{TH}}$ Calculation:}
			\begin{figure}[H]
			\centering
			\includegraphics[height=2.8cm,width=7.3cm]{Ep-32}
		\end{figure}
	\end{answer}
\end{enumerate}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.3cm,width=5cm]{Ep-34}
	\end{figure}
	\begin{answer}
		\begin{align*}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=4.6cm,width=5.5cm]{Ep-35}
	\end{figure}
	\begin{answer}
		\begin{align*}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2cm,width=5cm]{Ep-36}
	\end{figure}
	\begin{answer}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.4cm,width=4.7cm]{Ep-39}
	\end{figure}
$V_{i}=10 \sin \omega t$\\
	Sketch the output waveform if the input signal is indicated as:
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=4cm]{Ep-40}
	\end{figure}
	\begin{answer}
		\begin{align*}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=4cm]{Ep-41}
		\end{figure}
	\end{answer}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.3cm,width=5.5cm]{Ep-42}
	\end{figure}
	\begin{answer}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=5.5cm]{Ep-43}
		\end{figure}
		\begin{align*}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.3cm,width=8.5cm]{Ep-44}
	\end{figure}
	\begin{answer}
		Step-I: (When diode is ON for $0 \rightarrow \frac{\mathrm{I}}{2}$ )
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=5.5cm]{Ep-45}
		\end{figure}
		\begin{align*}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=5cm]{Ep-46}
		\end{figure}
	Step-III:
		\begin{figure}[H]
		\centering
		\includegraphics[height=2.7cm,width=8cm]{Ep-47}
	\end{figure}
	\end{answer}
	\item Draw the output waveform of the following circuit?
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.6cm,width=9cm]{Ep-48}
	\end{figure}
	\begin{answer}
		Step-I: When diode is on; $\left(\frac{\mathrm{T}}{2} \rightarrow \mathrm{T}\right)$
			\begin{figure}[H]
			\centering
			\includegraphics[height=2cm,width=4.5cm]{Ep-49}
		\end{figure}
