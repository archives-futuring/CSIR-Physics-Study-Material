...
\begin{figure}[H]
	\centering
	\includegraphics[height=2.7cm,width=5cm]{pl-crop}
	\caption{}
	\label{}
\end{figure}
...
\end{enumerate}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[height=4cm,width=12cm]{diagram-20211221(8)-crop}
 	\caption{}
 	\label{}
 \end{figure}
      ...
      \begin{figure}[H]
      	\centering
      	\includegraphics[height=4.5cm,width=8.5cm]{diagram-20211221(9)-crop}
      	\caption{}
      	\label{}
      \end{figure}
      ...
      \begin{figure}[H]
      	\centering
      	\includegraphics[height=4.7cm,width=8cm]{diagram-20211221(10)-crop}
      	\caption{}
      	\label{}
      \end{figure}
     ...
     \begin{figure}[H]
     	\centering
     	\includegraphics[height=2.5cm,width=6cm]{diagram-20211221(12)-crop}
     	\caption{}
     	\label{}
     \end{figure}
...
\begin{figure}[H]
 	\centering
 	\includegraphics[height=2.8cm,width=13cm]{diagram-20211222(12)-crop}
 	\caption{}
 	\label{}
 \end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3.7cm,width=11cm]{ely2(1)-crop}
	\caption{}
	\label{}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3.7cm,width=11cm]{detection-crop}
	\caption{}
	\label{}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=4cm,width=9cm]{diagram-20211224(5)-crop}
	\caption{}
	\label{}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=2.8cm,width=12cm]{detect-crop}
	\caption{}
	\label{}
\end{figure}
...
\begin{minipage}{\textwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.3cm,width=9cm]{diagram-20211011(8)-crop}
	\end{figure}
