...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=3.5cm]{diagram-20211011(27)-crop}
	\end{figure}
	...
	\begin{tasks}(2)
		\task[\textbf{A.}] \begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=3.5cm]{diagram-20211011(28)-crop}
		\end{figure}
		\task[\textbf{B.}] \begin{figure}[H]
			\centering
			\includegraphics[height=2.1cm,width=3.5cm]{diagram-20211011(29)-crop}
		\end{figure}
		\task[\textbf{C.}] \begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=3.5cm]{diagram-20211011(30)-crop}
		\end{figure}
		\task[\textbf{D.}] \begin{figure}[H]
			\centering
			\includegraphics[height=2.5cm,width=3.5cm]{diagram-20211011(31)-crop}
		\end{figure}
	\end{tasks}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=4cm]{diagram-20211011(22)-crop}
	\end{figure}
	\begin{tasks}(4)
		\task[\textbf{A.}] Zero
