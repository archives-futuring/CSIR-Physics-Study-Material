...
\begin{answer}$\left. \right. $\\
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=3cm]{diagram-20211011(26)-crop}
	\end{figure}
	 \begin{align*}
...
\begin{minipage}{\textwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=4cm,width=6cm]{diagram-20211011(54)-crop}
	\end{figure}
...
\begin{answer}$\left. \right. $\\
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=3.5cm]{diagram-20211011(55)-crop}
	\end{figure}
	\begin{align*}
...
\begin{minipage}{\textwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3.5cm,width=4cm]{diagram-20211011(11)-crop}
	\end{figure}
	$\text { The magnitude of the magnetic field at the point } O \text { is }$
	\exyear{NET 2018}
\end{minipage}
...
\begin{enumerate}
	\begin{minipage}{\textwidth}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[height=3cm,width=4cm]{diagram-20210817(13)-crop}
			\caption{}
			\label{}
		\end{figure}
	\end{minipage}
...
\end{align*}
	...
	\begin{answer}$\left. \right. $\\
		\begin{figure}[H]
			\centering
			\includegraphics[height=3cm,width=7cm]{jest 3-crop}
		\end{figure}
		\begin{align*}
