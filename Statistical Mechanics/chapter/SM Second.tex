...
$$\bar{v}=\sqrt{\frac{8 k T}{\pi m}} \cdots$$
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3.5cm,width=9.5cm]{diagram-20220527-3-crop}
	\end{figure}
...
\begin{tabular}{|p{5.5cm}|p{5.5cm}|p{5.5cm}|}
	\hline
\textbf{	Maxwell-Boltzmann}&\textbf{Fermi-Dirac}&\textbf{Bose-Einstein}\\
