...
\begin{figure}[H]
	\centering
	\includegraphics[height=3.5cm,width=7.7cm]{Net-D-19-8}
\end{figure}
\begin{answer}
	\begin{align*}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3cm,width=7cm]{Net-D-19-33}
\end{figure}	
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3cm,width=4.5cm]{Net-D-19-34}
\end{figure}
 \begin{tasks}(2)
...
\begin{answer}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[height=3cm,width=5cm]{Net-D-19-35}
 \end{figure}
	\begin{align*}
	\text{Thus }
...
\begin{answer}$\left. \right. $
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=4.5cm]{Net-D-19-36}
	\end{figure}
	\begin{align*}
	\text{
...
\begin{figure}[H]
	\centering
	\includegraphics[height=2.5cm,width=5cm]{Net-D-19-37}
\end{figure}
 \begin{tasks}(4)
...
\begin{answer}$\left. \right. $
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=5.5cm]{Net-D-19-38}
	\end{figure}
	\begin{align*}
...
\begin{answer}$\left. \right. $
	\begin{figure}[H]
		\centering
		\includegraphics[height=3cm,width=4cm]{Net-D-19-40}
	\end{figure}
	\begin{align*}
	y_{n+1}&=1-2 y_{t}^{2}\\
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3.5cm,width=4.5cm]{Net-D-19-39}
\end{figure}
