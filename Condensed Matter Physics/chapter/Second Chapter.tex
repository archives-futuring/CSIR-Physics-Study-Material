...
\text { The general solution to this }&\text{equation  is}\\
...
\text{where $A$ is a constant and $n$ is }&\text{an integer.  From here, we obtain for the eigenvalues}\\
...
\begin{figure}[H]
	\centering
	\includegraphics[height=2.5cm,width=6.5cm]{CMP-26}
	\caption{}
	\label{}
\end{figure}
...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3.5cm,width=4cm]{CMP-22}
		\caption{}
		\label{}
	\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[height=4cm,width=4cm]{diagram-20211026(3)-crop}
\end{figure}
\begin{tasks}(2)
...
\end{tasks}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=1cm,width=9cm]{diagram-20211026(4)-crop}
	\end{figure}
	is given by
	$$
