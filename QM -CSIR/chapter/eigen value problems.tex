...
\section{Eigen Values and Eigen Function}
 The values of energy $E_n$ for which Schrodinger steady state equation can be solved are called eigen values and the corresponding wavefunctions $\psi_{n}$ are called eigen functions.\\
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[height=3.3cm,width=4.5cm]{particle in abox}
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[height=4.5cm,width=5.5cm]{particle in a box1}
  	\caption{}
  	\label{}
  \end{figure}
...
$$
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[height=7cm,width=7.8cm]{3D degeneracy}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=6cm,width=7.5cm]{finite squre well}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=7cm,width=10.3cm]{diagram-20220112-crop}
	\caption{}
	\label{}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=4cm,width=3.2cm]{SHMclassical}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=6cm,width=8cm]{SHM1}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=7.5cm,width=8.5cm]{shm energy level}
...
\begin{minipage}{\textwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.5cm,width=4.5cm]{gate 5-crop}
	\end{figure}
\end{minipage}
\begin{tasks}(4)
...
\begin{minipage}{\textwidth}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=2.9cm,width=5cm]{diagram-20210825(3)-crop}
	\end{figure}
