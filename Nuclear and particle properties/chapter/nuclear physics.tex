...
\begin{figure}[H]
	\centering
	\includegraphics[height=2.7cm,width=6cm]{20.11-crop}
	\caption{}
	\label{}
\end{figure}
\begin{note}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=5.2cm,width=10cm]{diagram-20220307(4)-crop}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=5cm,width=5cm]{diagram-20211025-crop}
	\end{figure}
